...
TOOLS: list[Tool] = [
    ...
    Tool(
        ...
        description=(
            "מרנדר סרטוני רילס מטיוטות. קרא לכלי הזה כשהמשתמשת אומרת "
            "'רנדרי', 'תרנדרי', 'תייצרי סרטונים', 'אישור', 'מאשרת', 'יאללה', "
            "'קדימה', 'מעולה תמשיכי', 'סבבה', או כל ביטוי שמשמעותו שהיא רוצה "
            "להמשיך ליצירת הסרטונים. הכלי: שומר ב-Airtable, בוחר סרטוני רקע, "
            "מרנדר mp4, ומעלה לדף התוכן. "
            "⚠️ הפעולה לוקחת 2-5 דקות — קרא לכלי ואז עדכן את המשתמשת."
        ),
        parameters={
            "session_id": {
                "type": "string",
